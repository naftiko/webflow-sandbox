...
These are the OpenAPIs available for the Webflow Sandbox, which are made available via this sandbox API, which can be imported into Microcks and deployed as a sandbox using their mock feature.
  ...
  - [Asset Folders Openapi Original](openapi/asset-folders-openapi-original.yml)
  - [Assets Openapi Original](openapi/assets-openapi-original.yml)
  - [Collections Openapi Original](openapi/collections-openapi-original.yml)
  - [Form Submissions Openapi Original](openapi/form-submissions-openapi-original.yml)
  - [Forms Openapi Original](openapi/forms-openapi-original.yml)
  - [Pages Openapi Original](openapi/pages-openapi-original.yml)
  - [Sites Openapi Original](openapi/sites-openapi-original.yml)
  - [Token Openapi Original](openapi/token-openapi-original.yml)
  - [Webhooks Openapi Original](openapi/webhooks-openapi-original.yml)
  - [Workspaces Openapi Original](openapi/workspaces-openapi-original.yml)
